            ...
            <div className="p-4">
              ...
              <Table>
                <tbody>
                  ...
                  {this.props.cgst !== '0.00' && this.props.sgst !== '0.00' && (
                    <>
                      <tr className="text-end">
                        <td></td>
                        <td className="fw-bold" style={{width: '100px'}}>CGST</td>
                        <td className="text-end" style={{width: '100px'}}>{this.props.currency} {this.props.cgst}</td>
                      </tr>
                      <tr className="text-end">
                        <td></td>
                        <td className="fw-bold" style={{width: '100px'}}>SGST</td>
                        <td className="text-end" style={{width: '100px'}}>{this.props.currency} {this.props.sgst}</td>
                      </tr>
                    </>
                  )}
                  {this.props.igst !== '0.00' && (
                    <tr className="text-end">
                      ...
                      <td className="text-end" style={{width: '100px'}}>{this.props.currency} {this.props.igst}</td>
                    </tr>
                  )}
                  <tr className="text-end">
                    <td></td>
